...
CONST(Can_IdType, CAN_CONST) Can_FilterMasks_PC[CAN_MAXFILTERCOUNT_0] =
    {   
        /* FilterMasks_PC[0], "DefaultFilterMask" */
        (Can_IdType)0x7ffU,
        /* FilterMasks_PC[1], "DefaultExtFilterMask" */
...
/* @violates @ref Can_Cfg_c_REF_10 Violates MISRA 2004 Required Rule 8.10, external ... could be made static */
CONST(Can_ControllerBaudrateConfigType, CAN_CONST) ControllerBaudrateConfigs_PC_0[CAN_CFGSET0_MAX_BAUDRATE_FC_B_0] = {
