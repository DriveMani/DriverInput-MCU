...
#define OSNUSERISRCORE0 12U                /* The number of ISR2s assigned to core 0 */
...
#define OSNUSERISR 12U                     /* The number of ISR2s */
#define OSNISR 13U                         /* equal to summ of number ISR, system timers and TPTimer */
