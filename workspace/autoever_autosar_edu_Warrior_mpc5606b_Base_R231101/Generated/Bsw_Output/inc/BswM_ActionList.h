...
extern FUNC(void, BSWM_CODE) TrueAL_ComControl_Project_DISABLE_DM(void);

extern FUNC(void, BSWM_CODE) TrueAL_ComControl_Project_DISABLE_RX(void);

extern FUNC(void, BSWM_CODE) TrueAL_ComControl_Project_DISABLE_TX(void);

extern FUNC(void, BSWM_CODE) TrueAL_ComControl_Project_ENABLE_DM(void);

extern FUNC(void, BSWM_CODE) TrueAL_ComControl_Project_ENABLE_RX(void);

extern FUNC(void, BSWM_CODE) TrueAL_ComControl_Project_ENABLE_TX(void);

extern FUNC(void, BSWM_CODE) TrueAL_ComModeNotification_Project_FULL_COM(void);

extern FUNC(void, BSWM_CODE) TrueAL_ComModeNotification_Project_NO_COM(void);

extern FUNC(void, BSWM_CODE) TrueAL_ComModeNotification_Project_SILENT_COM(void);

extern FUNC(void, BSWM_CODE) TrueAL_ComModeRequest_Project_FULL_COM(void);

extern FUNC(void, BSWM_CODE) TrueAL_ComModeRequest_Project_NO_COM(void);
...
extern FUNC(void, BSWM_CODE) TrueAL_WakeupEventNotification_CAN1RX(void);

extern FUNC(void, BSWM_CODE) TrueAL_WakeupEventNotification_CAN1RX_POLL(void);
