...
*/
CONST(uint16,PORT_CONST) Port_NoUnUsedPadsArrayDefault_0[Port_NoUnUsedPins_0]=
{
(uint16)123,
(uint16)124,
(uint16)125,
...
* @violates @ref PORT_PBCFG_REF_5 Violates MISRA 2004 Required Rule 8.10
*/
CONST(Port_LLD_UnUsedPinConfigType, PORT_CONST) Port_LLD_UnUsedPin_0[1] =
{
 /**
...
*/
CONST(Port_LLD_PadSelConfigType, PORT_CONST) Port_LLD_PadSelConfigPB_0[PORT_NMBR_PSMI_REGS]=
{
         (uint32)0x01000000,
         (uint32)0x00000002,
         (uint32)0x02030000,
...
*/ 
#if (Port_NoUnUsedPins_0 != 0)
  Port_NoUnUsedPadsArrayDefault_0,
#else
  NULL_PTR,
#endif
  Port_LLD_UnUsedPin_0,
  Port_LLD_PinConfigPB_0,
/*
* @violates @ref PORT_PBCFG_REF_2 Violates MISRA 2004 Required Rule 10.1, Implicit
* conversion changes signedness.
*/
  Port_LLD_PadSelConfigPB_0
};
