...
,/* section size in bytes (must be multiple of 4) */
    (uint32)[!"num:inttohex(bit:shl(McuRamDefaultValue,24) + bit:shl(McuRamDefaultValue,16)+bit:shl(McuRamDefaultValue,8)+bit:shl(McuRamDefaultValue,0)) "!]ul /* value to be filled with */
    },
[!ELSE!][!//
    /* start of Mcu_RamConfig[[!"@index"!]] */
    {
...
[!VAR "TempMcuClcokSource"="@name"!]
        ...
        [!ENDIF!]
[!ENDLOOP!] [!ENDNOCODE!]
 /* start of Mcu_ModeConfig[[!"$PBindex"!]] */
 /*[!"McuOperatingMode"!]*/
    {
...
STATIC CONST(Mcu_ClockConfigType, MCU_CONST) Mcu_ClockConfigPB_[!"num:i(@index+1)"!][[!"num:i(count(McuClockSettingConfig/*))"!]] = {[!//
[!FOR "x" = "1" TO "num:i(count(McuClockSettingConfig/*))"!][!//
[!SELECT "McuClockSettingConfig/*/McuClockSettingId[.=$x]/.."!][!//
[!VAR "PBindex" = "$x"!][!//
/* start of Mcu_ClockConfig[[!"$PBindex"!]] */
    {
 [!NOCODE!][!//
...
[!ENDIF!][!//
    ...
    }[!IF "$PBindex<$NumClkConf"!],[!ENDIF!]
/* end of Mcu_ClockConfig[[!"$PBindex"!]] */
[!ENDSELECT!][!//
[!ENDFOR!][!//
};[!//
[!ENDIF!][!//
