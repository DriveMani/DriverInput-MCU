...
#endif
[!IF "(ecu:get('MCU.HAS_ECSM_RAM_WAIT') = 'true') and (ecu:get('MCU.HAS_ECSM_1') = 'true')"!][!//
    /* Configure RAM wait state */
    Ecsm_SetMUDCR((uint32)(ClockPtr->MUDCR),(uint32)(ClockPtr->MUDCR_1));
[!ELSEIF "(ecu:get('MCU.HAS_ECSM_RAM_WAIT') = 'true')"!][!//
    /* Configure RAM wait state */
...
[!IF "(ecu:get('MCU.DISABLE_SYSTEM_CLK') = 'true')"!][!//
