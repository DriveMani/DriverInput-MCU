...
[!IF "contains(ecu:get('MCU.RGM_Register.List'),'DERD')"!][!//

    /* @violates @ref Mcu_MC_Reset_LLD_c_REF_3 MISRA 2004 Rule 11.1, cast from unsigned long to pointer */
    REG_WRITE16(MC_RGM_DERD_R, (uint16) (ConfigLLDPtr->Destr_ResetOpt));
[!ENDIF!]
...
[!IF "contains(ecu:get('MCU.RGM_Register.List'),'DEAR')"!][!//

    /* @violates @ref Mcu_MC_Reset_LLD_c_REF_3 MISRA 2004 Rule 11.1, cast from unsigned long to pointer */
    REG_WRITE16(MC_RGM_DEAR_R, (uint16) (ConfigLLDPtr->Destr_SafeIsrOpt));/* Spectrum cut 1*/
[!ENDIF!]
...
[!IF "contains(ecu:get('Mcu.ResetReason.List'),'MCU_SOFT_DEST_RESET')"!][!//
    else if (MCU_MASK_SOFT_DEST_RESET == (RawResetReg & (MCU_MASK_SOFT_DEST_RESET)) )
    {
        RawReset = MCU_SOFT_DEST_RESET; /* soft destructive reset */
        ResetBitMask = MCU_MASK_SOFT_DEST_RESET;
    }
[!ENDIF!][!//
[!IF "contains(ecu:get('Mcu.ResetReason.List'),'MCU_SOFT_FUNC_RESET')"!][!//
    else if (MCU_MASK_SOFT_FUNC_RESET == (RawResetReg & (MCU_MASK_SOFT_FUNC_RESET)) )
    {
        RawReset = MCU_SOFT_FUNC_RESET; /* soft functional reset */
        ResetBitMask = MCU_MASK_SOFT_FUNC_RESET;
    }
[!ENDIF!][!//

[!IF "contains(ecu:get('Mcu.ResetReason.List'),'MCU_2_7_LV_IO_RESET')"!][!//
    else if (MCU_MASK_LVD27_IO_RESET == (RawResetReg & (MCU_MASK_LVD27_IO_RESET)) )
    {
        RawReset = MCU_2_7_LV_IO_RESET;
        ResetBitMask = MCU_MASK_LVD27_IO_RESET;
    }
[!ENDIF!][!//
[!IF "contains(ecu:get('Mcu.ResetReason.List'),'MCU_2_7_LV_FLASH_RESET')"!][!//
    else if (MCU_MASK_LVD27_FLASH_RESET == (RawResetReg & (MCU_MASK_LVD27_FLASH_RESET)) )
    {
        RawReset = MCU_2_7_LV_FLASH_RESET;
        ResetBitMask = MCU_MASK_LVD27_FLASH_RESET;
    }
[!ENDIF!][!//
[!IF "contains(ecu:get('Mcu.ResetReason.List'),'MCU_2_7_LV_VREG_RESET')"!][!//
...
[!ENDIF!][!//
[!IF "contains(ecu:get('Mcu.ResetReason.List'),'MCU_2_7_LOW_VOLTAGE')"!][!//
...
[!ENDIF!][!//
[!IF "contains(ecu:get('Mcu.ResetReason.List'),'MCU_SWT_D_RESET')"!][!//
...
[!ENDIF!][!//
[!IF "contains(ecu:get('Mcu.ResetReason.List'),'MCU_SWT1_D_RESET')"!][!//
    else if (MCU_MASK_SWT1_D_RESET == (RawResetReg & (MCU_MASK_SWT1_D_RESET)) )
    {
        RawReset = MCU_WATCHDOG1_RESET;
        ResetBitMask = MCU_MASK_SWT1_D_RESET; 
    }
[!ENDIF!][!//
[!IF "contains(ecu:get('Mcu.ResetReason.List'),'MCU_1_2_LV_PW_DOMAIN_1')"!][!//
...
[!ENDIF!][!//
[!IF "contains(ecu:get('Mcu.ResetReason.List'),'MCU_1_2_HV_RESET')"!][!//
    else if (MCU_MASK_HVD12_RESET == (RawResetReg & (MCU_MASK_HVD12_RESET)) )
    {
        RawReset = MCU_1_2_HV_RESET;
        ResetBitMask = MCU_MASK_HVD12_RESET;
    }
[!ENDIF!][!//
[!IF "contains(ecu:get('Mcu.ResetReason.List'),'MCU_2_7_LV_ADC_RESET')"!][!//
    else if (MCU_MASK_LVD27_ADC_RESET == (RawResetReg & (MCU_MASK_LVD27_ADC_RESET)) )
    {
        RawReset = MCU_LVD27_ADC_RESET; /* Flag for 2.7 V low-voltage det. (ADC supply) */
        ResetBitMask = MCU_MASK_LVD27_ADC_RESET;
    }
[!ENDIF!][!//
[!IF "contains(ecu:get('Mcu.ResetReason.List'),'MCU_1_2_LV_PW_DOMAIN_0')"!][!//
...
[!ENDIF!][!//
[!IF "contains(ecu:get('Mcu.ResetReason.List'),'MCU_1_2_LV_RESET')"!][!//
    /* Check reset reason */ 
    else if (MCU_MASK_LVD12_RESET == (RawResetReg & MCU_MASK_LVD12_RESET))
    {
        RawReset = MCU_1_2_LV_RESET;
        ResetBitMask = MCU_MASK_LVD12_RESET;
    }
[!ENDIF!][!//
[!IF "contains(ecu:get('Mcu.ResetReason.List'),'MCU_ST_NCF_RESET')"!][!//
    else if ((RawResetReg & (MCU_MASK_ST_NCF_RESET)) == MCU_MASK_ST_NCF_RESET)
    {
        RawReset = MCU_ST_NCF_RESET;
        ResetBitMask = MCU_MASK_ST_NCF_RESET;
    }
[!ENDIF!][!//
[!IF "contains(ecu:get('Mcu.ResetReason.List'),'MCU_FCCU_HARD_RESET')"!][!//
    else if (MCU_MASK_FCCU_HARD_RESET == (RawResetReg & (MCU_MASK_FCCU_HARD_RESET)) )
    {
        RawReset = MCU_FCCU_HARD_RESET;
        ResetBitMask = MCU_MASK_FCCU_HARD_RESET;
    }
[!ENDIF!][!//
[!IF "contains(ecu:get('Mcu.ResetReason.List'),'MCU_FCCU_SOFT_RESET')"!][!//
    else if (MCU_MASK_FCCU_SOFT_RESET == (RawResetReg & (MCU_MASK_FCCU_SOFT_RESET)) )
    {
        RawReset = MCU_FCCU_SOFT_RESET;
        ResetBitMask = MCU_MASK_FCCU_SOFT_RESET;
    }
[!ENDIF!][!//
[!IF "contains(ecu:get('Mcu.ResetReason.List'),'MCU_ST_CF_RESET')"!][!//
    else if ((RawResetReg & (MCU_MASK_ST_CF_RESET)) == MCU_MASK_ST_CF_RESET)
    {
        RawReset = MCU_ST_CF_RESET;
        ResetBitMask = MCU_MASK_ST_CF_RESET;
    }
[!ENDIF!][!//
[!IF "contains(ecu:get('Mcu.ResetReason.List'),'MCU_ST_DONE_RESET')"!][!//
    else if (MCU_MASK_ST_DONE_RESET == (RawResetReg & (MCU_MASK_ST_DONE_RESET)) )
    {
        RawReset = MCU_ST_DONE_RESET;
        ResetBitMask = MCU_MASK_ST_DONE_RESET;
    }
[!ENDIF!][!//
[!IF "contains(ecu:get('Mcu.ResetReason.List'),'MCU_CMU12_FHL_RESET')"!][!//
    else if (MCU_MASK_CMU12_FHL_RESET == (RawResetReg & (MCU_MASK_CMU12_FHL_RESET)) )
    {
        RawReset = MCU_CMU12_FHL_RESET;
        ResetBitMask = MCU_MASK_CMU12_FHL_RESET;
    }
[!ENDIF!][!//
[!IF "contains(ecu:get('Mcu.ResetReason.List'),'MCU_FL_ECC_RCC_RESET')"!][!//
    else if (MCU_MASK_FL_ECC_RCC_RESET == (RawResetReg & (MCU_MASK_FL_ECC_RCC_RESET)) )
    {
        RawReset = MCU_FL_ECC_RCC_RESET;
        ResetBitMask = MCU_MASK_FL_ECC_RCC_RESET; 
    }
[!ENDIF!][!//
[!IF "contains(ecu:get('Mcu.ResetReason.List'),'MCU_Z4CORE_RESET')"!][!//
    else if ((RawResetReg & (MCU_MASK_Z4CORE_RESET)) == MCU_MASK_Z4CORE_RESET)
    {
        RawReset = MCU_Z4CORE_RESET;
        ResetBitMask = MCU_MASK_Z4CORE_RESET;
    }
[!ENDIF!][!//
[!IF "contains(ecu:get('Mcu.ResetReason.List'),'MCU_PLL1_RESET')"!][!//
    else if (MCU_MASK_PLL1_RESET == (RawResetReg & (MCU_MASK_PLL1_RESET)) )
    {
        RawReset = MCU_PLL1_RESET;
        ResetBitMask = MCU_MASK_PLL1_RESET;
    }
[!ENDIF!][!//
[!IF "contains(ecu:get('Mcu.ResetReason.List'),'MCU_WATCHDOG_RESET')"!][!//
    else if ((RawResetReg & (MCU_MASK_SWT_F_RESET)) == MCU_MASK_SWT_F_RESET)
    {
        RawReset = MCU_WATCHDOG_RESET;
        ResetBitMask = MCU_MASK_SWT_F_RESET;
    }
[!ENDIF!][!//
[!IF "contains(ecu:get('Mcu.ResetReason.List'),'MCU_FLASH_RESET')"!][!//
...
[!ENDIF!][!//
[!IF "contains(ecu:get('Mcu.ResetReason.List'),'MCU_FCCU_SAFE_RESET')"!][!//
    else if (MCU_MASK_FCCU_SAFE_RESET == (RawResetReg & (MCU_MASK_FCCU_SAFE_RESET)) )
    {
        RawReset = MCU_FCCU_SAFE_RESET;
        ResetBitMask = MCU_MASK_FCCU_SAFE_RESET;
    }
[!ENDIF!][!//
[!IF "contains(ecu:get('Mcu.ResetReason.List'),'MCU_4_5_LOW_VOLTAGE')"!][!//
...
[!ENDIF!][!//
[!IF "contains(ecu:get('Mcu.ResetReason.List'),'MCU_CMU_FHL_RESET')"!][!//
...
[!ENDIF!][!//
[!IF "contains(ecu:get('Mcu.ResetReason.List'),'MCU_CMU_OLR_RESET')"!][!//
...
[!ENDIF!][!//
[!IF "contains(ecu:get('Mcu.ResetReason.List'),'MCU_PLL0_RESET')"!][!//
...
[!ENDIF!][!//
[!IF "contains(ecu:get('Mcu.ResetReason.List'),'MCU_CWD_RESET')"!][!//
    else if (MCU_MASK_CWD_RESET == (RawResetReg & (MCU_MASK_CWD_RESET)) )
    {
        RawReset = MCU_CWD_RESET;
        ResetBitMask = MCU_MASK_CWD_RESET;
    }
[!ENDIF!][!//
[!IF "contains(ecu:get('Mcu.ResetReason.List'),'MCU_CHECKSTOP_RESET')"!][!//
...
[!ENDIF!][!//
[!IF "contains(ecu:get('Mcu.ResetReason.List'),'MCU_SW_RESET')"!][!//
...
[!ENDIF!][!//
[!IF "contains(ecu:get('Mcu.ResetReason.List'),'MCU_CORE_RESET')"!][!//
...
[!ENDIF!][!//
[!IF "contains(ecu:get('Mcu.ResetReason.List'),'MCU_JTAG_RESET')"!][!//
...
[!IF "(ecu:get('MCU.RGM_DESTRUCTIVE_RESET') = 'false')"!][!//
    FUNC(void, MCU_CODE) Mcu_RGM_PerformReset(VAR(void, AUTOMATIC))
[!ELSE!]
    FUNC(void, MCU_CODE) Mcu_RGM_PerformReset(VAR (Mcu_MC_ResetType, AUTOMATIC) ResetType)
[!ENDIF!]
    {
        /* @violates @ref Mcu_MC_Reset_LLD_c_REF_3 MISRA 2004 Rule 11.1, cast from unsigned long to pointer */
...
/* @errata ERR_IPV_MC_0004 */
     ...
     #endif 
#endif 
[!IF "(ecu:get('MCU.RGM_DESTRUCTIVE_RESET') = 'true')"!][!//
        if (MCU_FUNC_RESET == (ResetType))
        {
[!ENDIF!][!//
            /* @violates @ref Mcu_MC_Reset_LLD_c_REF_3 MISRA 2004 Rule 11.1, cast from unsigned long to pointer */
...
[!IF "(ecu:get('MCU.RGM_DESTRUCTIVE_RESET') = 'true')"!][!//
        ...
        else
        {
            /* Destructive reset */
            /* @violates @ref Mcu_MC_Reset_LLD_c_REF_3 MISRA 2004 Rule 11.1, cast from unsigned long to pointer */
            REG_WRITE32(MC_ME_MCTL_R, ((((uint32)MCU_DEST_RESET_MODE) << MCU_SHIFT_TWENTY_EIGHT) | MCU_SOFT_CONTROL_KEY_ONE));
            /* @violates @ref Mcu_MC_Reset_LLD_c_REF_3 MISRA 2004 Rule 11.1, cast from unsigned long to pointer */
            REG_WRITE32(MC_ME_MCTL_R, ((((uint32)MCU_DEST_RESET_MODE) << MCU_SHIFT_TWENTY_EIGHT) | MCU_SOFT_CONTROL_KEY_TWO));
        }
[!ENDIF!][!//
       }
#if (MCU_DEV_ERROR_DETECT == STD_ON)
