...
[!IF "contains(ecu:get('MCU.CMU.List'),'CMU1')"!][!//

    /* @violates @ref Mcu_MC_Monitor_LLD_c_REF_3 MISRA 2004 Rule 11.1, cast from unsigned long to pointer */
    REG_WRITE32(MC_CGM_CMU1_LFREFR_R, MCU_CMU_LREF_VALUE);
    
    /* @violates @ref Mcu_MC_Monitor_LLD_c_REF_3 MISRA 2004 Rule 11.1, cast from unsigned long to pointer */
    REG_WRITE32(MC_CGM_CMU1_HFREFR_R, MCU_CMU_HREF_VALUE);
[!ENDIF!][!//    
[!IF "contains(ecu:get('MCU.CMU.List'),'CMU2')"!][!//
    /* @violates @ref Mcu_MC_Monitor_LLD_c_REF_3 MISRA 2004 Rule 11.1, cast from unsigned long to pointer */
    REG_WRITE32(MC_CGM_CMU2_LFREFR_R, MCU_CMU_LREF_VALUE);
    
    /* @violates @ref Mcu_MC_Monitor_LLD_c_REF_3 MISRA 2004 Rule 11.1, cast from unsigned long to pointer */
    REG_WRITE32(MC_CGM_CMU2_HFREFR_R, MCU_CMU_HREF_VALUE);
[!ENDIF!][!//
 }
...
FUNC (void, MCU_CODE) Mcu_Disable_Monitor(VAR (uint8, AUTOMATIC) CmuIndex)
{
    switch(CmuIndex) 
    {
[!IF "contains(ecu:get('MCU.CMU.List'),'CMU0')"!][!//
        case MC_CGM_CMU0:
            /* @violates @ref Mcu_MC_Monitor_LLD_c_REF_3 MISRA 2004 Rule 11.1, cast from unsigned long to pointer */
...
[!IF "contains(ecu:get('MCU.CMU.List'),'CMU1')"!][!//
        case MC_CGM_CMU1:
            /* @violates @ref Mcu_MC_Monitor_LLD_c_REF_3 MISRA 2004 Rule 11.1, cast from unsigned long to pointer */
            REG_BIT_CLEAR32(MC_CGM_CMU1_CSR_R, (uint32) MC_CGM_CMU_CME_BIT);
            break;
[!ENDIF!][!//
[!IF "contains(ecu:get('MCU.CMU.List'),'CMU2')"!][!//
        case MC_CGM_CMU2:
            /* @violates @ref Mcu_MC_Monitor_LLD_c_REF_3 MISRA 2004 Rule 11.1, cast from unsigned long to pointer */
            REG_BIT_CLEAR32(MC_CGM_CMU2_CSR_R, (uint32) MC_CGM_CMU_CME_BIT);
            break;
[!ENDIF!][!//
[!IF "contains(ecu:get('MCU.CMU.List'),'CMU3')"!][!//
        case MC_CGM_CMU3:
            /* @violates @ref Mcu_MC_Monitor_LLD_c_REF_3 MISRA 2004 Rule 11.1, cast from unsigned long to pointer */
            REG_BIT_CLEAR32(MC_CGM_CMU3_CSR_R, (uint32) MC_CGM_CMU_CME_BIT);
            break;
[!ENDIF!][!//
[!IF "contains(ecu:get('MCU.CMU.List'),'CMU4')"!][!//
        case MC_CGM_CMU4:
            /* @violates @ref Mcu_MC_Monitor_LLD_c_REF_3 MISRA 2004 Rule 11.1, cast from unsigned long to pointer */
            REG_BIT_CLEAR32(MC_CGM_CMU4_CSR_R, (uint32) MC_CGM_CMU_CME_BIT);
            break;
[!ENDIF!][!//
[!IF "contains(ecu:get('MCU.CMU.List'),'CMU5')"!][!//
        case MC_CGM_CMU5:
            /* @violates @ref Mcu_MC_Monitor_LLD_c_REF_3 MISRA 2004 Rule 11.1, cast from unsigned long to pointer */
            REG_BIT_CLEAR32(MC_CGM_CMU5_CSR_R, (uint32) MC_CGM_CMU_CME_BIT);
            break;
[!ENDIF!][!//
[!IF "contains(ecu:get('MCU.CMU.List'),'CMU6')"!][!//
        case MC_CGM_CMU6:
            /* @violates @ref Mcu_MC_Monitor_LLD_c_REF_3 MISRA 2004 Rule 11.1, cast from unsigned long to pointer */
            REG_BIT_CLEAR32(MC_CGM_CMU6_CSR_R, (uint32) MC_CGM_CMU_CME_BIT);
            break;
[!ENDIF!][!//
[!IF "contains(ecu:get('MCU.CMU.List'),'CMU7')"!][!//
        case MC_CGM_CMU7:
            /* @violates @ref Mcu_MC_Monitor_LLD_c_REF_3 MISRA 2004 Rule 11.1, cast from unsigned long to pointer */
            REG_BIT_CLEAR32(MC_CGM_CMU7_CSR_R, (uint32) MC_CGM_CMU_CME_BIT);
            break;
[!ENDIF!][!//
[!IF "contains(ecu:get('MCU.CMU.List'),'CMU8')"!][!//
        case MC_CGM_CMU8:
            /* @violates @ref Mcu_MC_Monitor_LLD_c_REF_3 MISRA 2004 Rule 11.1, cast from unsigned long to pointer */
            REG_BIT_CLEAR32(MC_CGM_CMU8_CSR_R, (uint32) MC_CGM_CMU_CME_BIT);
            break;
[!ENDIF!][!//
[!IF "contains(ecu:get('MCU.CMU.List'),'CMU9')"!][!//
        case MC_CGM_CMU9:
            /* @violates @ref Mcu_MC_Monitor_LLD_c_REF_3 MISRA 2004 Rule 11.1, cast from unsigned long to pointer */
            REG_BIT_CLEAR32(MC_CGM_CMU9_CSR_R, (uint32) MC_CGM_CMU_CME_BIT);
            break;
[!ENDIF!][!//
[!IF "contains(ecu:get('MCU.CMU.List'),'CMU10')"!][!//
        case MC_CGM_CMU10:
            /* @violates @ref Mcu_MC_Monitor_LLD_c_REF_3 MISRA 2004 Rule 11.1, cast from unsigned long to pointer */
            REG_BIT_CLEAR32(MC_CGM_CMU10_CSR_R, (uint32) MC_CGM_CMU_CME_BIT);
            break;
[!ENDIF!][!//
[!IF "contains(ecu:get('MCU.CMU.List'),'CMU12')"!][!//
        case MC_CGM_CMU12:
            /* @violates @ref Mcu_MC_Monitor_LLD_c_REF_3 MISRA 2004 Rule 11.1, cast from unsigned long to pointer */
            REG_BIT_CLEAR32(MC_CGM_CMU12_CSR_R, (uint32) MC_CGM_CMU_CME_BIT);
            break;
[!ENDIF!][!//
        default:
#if (MCU_DEV_ERROR_DETECT == STD_ON)
...
[!IF "contains(ecu:get('MCU.CMU.List'),'CMU1')"!][!//
    ...
    /* @violates @ref Mcu_MC_Monitor_LLD_c_REF_3 MISRA 2004 Rule 11.1, cast from unsigned long to pointer */
    REG_WRITE32(MC_CGM_CMU1_CSR_R, (uint32) MCU_CMU_CR_RESET_VALUE);
    /* @violates @ref Mcu_MC_Monitor_LLD_c_REF_3 MISRA 2004 Rule 11.1, cast from unsigned long to pointer */
    REG_WRITE32(MC_CGM_CMU1_ISR_R, (uint32) MCU_CMU_ISR_CLEAR_VALUE);
[!ENDIF!][!//
[!IF "contains(ecu:get('MCU.CMU.List'),'CMU2')"!][!//
    
    /* @violates @ref Mcu_MC_Monitor_LLD_c_REF_3 MISRA 2004 Rule 11.1, cast from unsigned long to pointer */
    REG_WRITE32(MC_CGM_CMU2_CSR_R, (uint32) MCU_CMU_CR_RESET_VALUE);
    /* @violates @ref Mcu_MC_Monitor_LLD_c_REF_3 MISRA 2004 Rule 11.1, cast from unsigned long to pointer */
    REG_WRITE32(MC_CGM_CMU2_ISR_R, (uint32) MCU_CMU_ISR_CLEAR_VALUE);
[!ENDIF!][!//
    /* @violates @ref Mcu_MC_Monitor_LLD_c_REF_3 MISRA 2004 Rule 11.1, cast from unsigned long to pointer */
...
[!IF "contains(ecu:get('MCU.CMU.List'),'CMU1')"!][!//
        if (((ClockPtr->Clk_Monitor1) & (MCU_SHIFT_ONE << MCU_SHIFT_TWENTY_SIX)) == (MCU_SHIFT_ONE << MCU_SHIFT_TWENTY_SIX))   /* Check if the Monitor is enabled */
        {
            /* This is applicable for the following lines of code */
            /* @violates @ref Mcu_MC_Monitor_LLD_c_REF_3 MISRA 2004 Rule 11.1, cast from unsigned long to pointer */
            REG_BIT_CLEAR32(MC_CGM_CMU1_CSR_R, MCU_ONE_VALUE);
            /* @violates @ref Mcu_MC_Monitor_LLD_c_REF_3 MISRA 2004 Rule 11.1, cast from unsigned long to pointer */
            REG_RMW32(MC_CGM_CMU1_CSR_R, CMU0_RCDIV_MASK, (((ClockPtr->Clk_Monitor1) & (MCU_SHIFT_THREE << MCU_SHIFT_TWENTY_FOUR)) >> MCU_SHIFT_TWENTY_THREE)); /* Set RCDIV value:
                                                                                                           Fosc <=
                                                                                                           16MHz/2^RCDIV */
            /* @violates @ref Mcu_MC_Monitor_LLD_c_REF_3 MISRA 2004 Rule 11.1, cast from unsigned long to pointer */
            REG_WRITE32(MC_CGM_CMU1_LFREFR_R, (((ClockPtr->Clk_Monitor1) & (MCU_CMU_REF_MASK << MCU_SHIFT_TWELVE)) >> MCU_SHIFT_TWELVE)); /* Set
                                                                                                                       Low
                                                                                                                       Frequency
                                                                                                                       Reference
                                                                                                                     */
            /* @violates @ref Mcu_MC_Monitor_LLD_c_REF_3 MISRA 2004 Rule 11.1, cast from unsigned long to pointer */
            REG_WRITE32(MC_CGM_CMU1_HFREFR_R, ((ClockPtr->Clk_Monitor1) & (MCU_CMU_REF_MASK))); /* Set High Frequency Reference */
            /* Enable the Monitor */
            /* @violates @ref Mcu_MC_Monitor_LLD_c_REF_3 MISRA 2004 Rule 11.1, cast from unsigned long to pointer */
            REG_BIT_SET32(MC_CGM_CMU1_CSR_R, (((ClockPtr->Clk_Monitor1) & (MCU_SHIFT_ONE << MCU_SHIFT_TWENTY_SIX)) >> MCU_SHIFT_TWENTY_SIX)); 
        }
[!ENDIF!][!//
[!IF "contains(ecu:get('MCU.CMU.List'),'CMU2')"!][!//
        if (((ClockPtr->Clk_Monitor2) & (MCU_SHIFT_ONE << MCU_SHIFT_TWENTY_SIX)) == (MCU_SHIFT_ONE << MCU_SHIFT_TWENTY_SIX))   /* Check if the Monitor is enabled */
        {
            /* This is applicable for the following lines of code */
            /* @violates @ref Mcu_MC_Monitor_LLD_c_REF_3 MISRA 2004 Rule 11.1, cast from unsigned long to pointer */
            REG_BIT_CLEAR32(MC_CGM_CMU2_CSR_R, MCU_ONE_VALUE);
            /* @violates @ref Mcu_MC_Monitor_LLD_c_REF_3 MISRA 2004 Rule 11.1, cast from unsigned long to pointer */
            REG_RMW32(MC_CGM_CMU2_CSR_R, CMU0_RCDIV_MASK, (((ClockPtr->Clk_Monitor2) & (MCU_SHIFT_THREE << MCU_SHIFT_TWENTY_FOUR)) >> MCU_SHIFT_TWENTY_THREE)); /* Set RCDIV value:
                                                                                                           Fosc <=
                                                                                                           16MHz/2^RCDIV */
            /* @violates @ref Mcu_MC_Monitor_LLD_c_REF_3 MISRA 2004 Rule 11.1, cast from unsigned long to pointer */
            REG_WRITE32(MC_CGM_CMU2_LFREFR_R, (((ClockPtr->Clk_Monitor2) & (MCU_CMU_REF_MASK << MCU_SHIFT_TWELVE)) >> MCU_SHIFT_TWELVE)); /* Set
                                                                                                                       Low
                                                                                                                       Frequency
                                                                                                                       Reference
                                                                                                                     */
            /* @violates @ref Mcu_MC_Monitor_LLD_c_REF_3 MISRA 2004 Rule 11.1, cast from unsigned long to pointer */
            REG_WRITE32(MC_CGM_CMU2_HFREFR_R, ((ClockPtr->Clk_Monitor2) & (MCU_CMU_REF_MASK))); /* Set High Frequency Reference */
            /* Enable the Monitor */
            /* @violates @ref Mcu_MC_Monitor_LLD_c_REF_3 MISRA 2004 Rule 11.1, cast from unsigned long to pointer */
            REG_BIT_SET32(MC_CGM_CMU2_CSR_R, (((ClockPtr->Clk_Monitor2) & (MCU_SHIFT_ONE << MCU_SHIFT_TWENTY_SIX)) >> MCU_SHIFT_TWENTY_SIX)); 
        }
[!ENDIF!][!//
...
[!IF "contains(ecu:get('MCU.CMU.List'),'CMU1')"!][!//
    /* Fsys < LOW fail event */
    /* @violates @ref Mcu_MC_Monitor_LLD_c_REF_3 MISRA 2004 Rule 11.1, cast from unsigned long to pointer */
    if ((uint32) MCU_TWO_VALUE == (REG_READ32(MC_CGM_CMU1_ISR_R) & ((uint32) MCU_TWO_VALUE))  )   
    {
        if (MCU_CLOCKNOTIFICATION_ENABLE == Mcu_CpyClockNotification )
        {
#if (MCU_DISABLE_DEM_REPORT_ERROR_STATUS == STD_ON)
        ...
        /* @violates @ref Mcu_MC_Monitor_LLD_c_REF_3 MISRA 2004 Rule 11.1, cast from unsigned long to pointer */
        REG_WRITE32(MC_CGM_CMU1_ISR_R,(uint32)MCU_TWO_VALUE);
         do {
          /* @violates @ref Mcu_MC_Monitor_LLD_c_REF_3 MISRA 2004 Rule 11.1, cast from unsigned long to pointer */
          REG_WRITE16(MC_RGM_FES_R,(uint16)MCU_OSC_CMU12_HIGH_FREQ_INT);
          /* @violates @ref Mcu_MC_Monitor_LLD_c_REF_3 MISRA 2004 Rule 11.1, cast from unsigned long to pointer */
          TempReg = REG_READ16(MC_RGM_FES_R); /* Read FES */
          Loop++;
          }
      while (((TempReg & (uint16)MCU_OSC_CMU12_HIGH_FREQ_INT) != (uint16)(MCU_ZERO_VALUE)) && (Loop < Timeout));
    }
    /* Fsys > HIGH fail event */
    /* @violates @ref Mcu_MC_Monitor_LLD_c_REF_3 MISRA 2004 Rule 11.1, cast from unsigned long to pointer */
    if ((uint32) MCU_FOUR_VALUE == (REG_READ32(MC_CGM_CMU1_ISR_R) & ((uint32) MCU_FOUR_VALUE)) )   
    {
        if (MCU_CLOCKNOTIFICATION_ENABLE == Mcu_CpyClockNotification )
        {
#if (MCU_DISABLE_DEM_REPORT_ERROR_STATUS == STD_ON)
        ...
        /* @violates @ref Mcu_MC_Monitor_LLD_c_REF_3 MISRA 2004 Rule 11.1, cast from unsigned long to pointer */
        REG_WRITE32(MC_CGM_CMU1_ISR_R,(uint32)MCU_FOUR_VALUE);
       do {
          /* @violates @ref Mcu_MC_Monitor_LLD_c_REF_3 MISRA 2004 Rule 11.1, cast from unsigned long to pointer */
          REG_WRITE16(MC_RGM_FES_R,(uint16)MCU_OSC_CMU12_HIGH_FREQ_INT);
          /* @violates @ref Mcu_MC_Monitor_LLD_c_REF_3 MISRA 2004 Rule 11.1, cast from unsigned long to pointer */
...
[!IF "contains(ecu:get('MCU.CMU.List'),'CMU2')"!][!//
    /* Fsys < LOW fail event */
    /* @violates @ref Mcu_MC_Monitor_LLD_c_REF_3 MISRA 2004 Rule 11.1, cast from unsigned long to pointer */
    if ((uint32) MCU_TWO_VALUE == (REG_READ32(MC_CGM_CMU2_ISR_R) & ((uint32) MCU_TWO_VALUE)) )   
    {
        if (MCU_CLOCKNOTIFICATION_ENABLE == Mcu_CpyClockNotification )
        {
#if (MCU_DISABLE_DEM_REPORT_ERROR_STATUS == STD_ON)
        ...
        /* @violates @ref Mcu_MC_Monitor_LLD_c_REF_3 MISRA 2004 Rule 11.1, cast from unsigned long to pointer */
        REG_WRITE32(MC_CGM_CMU2_ISR_R,(uint32)MCU_TWO_VALUE);
        do {
          /* @violates @ref Mcu_MC_Monitor_LLD_c_REF_3 MISRA 2004 Rule 11.1, cast from unsigned long to pointer */
          REG_WRITE16(MC_RGM_FES_R,(uint16)MCU_OSC_CMU12_HIGH_FREQ_INT);
          /* @violates @ref Mcu_MC_Monitor_LLD_c_REF_3 MISRA 2004 Rule 11.1, cast from unsigned long to pointer */
    ...
    /* Fsys > HIGH fail event */
    /* @violates @ref Mcu_MC_Monitor_LLD_c_REF_3 MISRA 2004 Rule 11.1, cast from unsigned long to pointer */
    if ((uint32) MCU_FOUR_VALUE == (REG_READ32(MC_CGM_CMU2_ISR_R) & ((uint32) MCU_FOUR_VALUE)) )   
    {
        if (MCU_CLOCKNOTIFICATION_ENABLE == Mcu_CpyClockNotification )
        {
#if (MCU_DISABLE_DEM_REPORT_ERROR_STATUS == STD_ON)
        ...
        /* @violates @ref Mcu_MC_Monitor_LLD_c_REF_3 MISRA 2004 Rule 11.1, cast from unsigned long to pointer */
        REG_WRITE32(MC_CGM_CMU2_ISR_R,(uint32)MCU_FOUR_VALUE);
        do {
          /* @violates @ref Mcu_MC_Monitor_LLD_c_REF_3 MISRA 2004 Rule 11.1, cast from unsigned long to pointer */
          REG_WRITE16(MC_RGM_FES_R,(uint16)MCU_OSC_CMU12_HIGH_FREQ_INT);
          /* @violates @ref Mcu_MC_Monitor_LLD_c_REF_3 MISRA 2004 Rule 11.1, cast from unsigned long to pointer */
