...
* @api
*/
#define MCU_GET_RAM_STATE_API                   ([!IF "McuGeneralConfiguration/McuGetRamStateApi"!]STD_ON[!ELSE!]STD_OFF[!ENDIF!])
...
* @api
*/
#define MCU_GET_DEVICE_INFO_API                   ([!IF "NonAutosar/McuGetDeviceInfoApi"!]STD_ON[!ELSE!]STD_OFF[!ENDIF!])
 ...
 * @api
 */
#define MCU_SSCM_ERROR_CONFIG                   ([!IF "(McuGeneralConfiguration/McuSscmRAE[.='true'] or McuGeneralConfiguration/McuSscmPAE[.='true'])"!]STD_ON[!ELSE!]STD_OFF[!ENDIF!])
...
* @api
*/
#define MCU_SSCM_GET_STATUS_API                 ([!IF "NonAutosar/McuSscmGetSystemStatus"!]STD_ON[!ELSE!]STD_OFF[!ENDIF!])
...
* @api
*/
#define MCU_SSCM_GET_MEMCONFIG_API              ([!IF "NonAutosar/McuSscmGetMemConfig"!]STD_ON[!ELSE!]STD_OFF[!ENDIF!])
...
* @api
*/
#define MCU_DMA_INIT                            ([!IF "McuGeneralConfiguration/McuDmaInit"!]STD_ON[!ELSE!]STD_OFF[!ENDIF!])
...
* @api
*/
#define MCU_INIT_CLOCK                          ([!IF "McuGeneralConfiguration/McuInitClock"!]TRUE[!ELSE!]FALSE[!ENDIF!])
...
#define MCU_INIT_CLOCK_DISABLE_PERIPHERAL       ([!IF "McuGeneralConfiguration/McuDisablePeripheralDuringInitclock"!]TRUE[!ELSE!]FALSE[!ENDIF!])  
...
* @api
*/
#define MCU_NO_PLL                              ([!IF "McuGeneralConfiguration/McuNoPll"!]TRUE[!ELSE!]FALSE[!ENDIF!])
...
* @api
*/
#define MCU_LP_TRANSITION_CHECK     ([!IF "McuGeneralConfiguration/McuLPTransitionCheck = 'true'"!]STD_ON[!ELSE!]STD_OFF[!ENDIF!])
 ...
 * @api
 */
#define MCU_SKIP_FUNCTION            ([!IF "McuGeneralConfiguration/McuSkipFunction"!]STD_ON[!ELSE!]STD_OFF[!ENDIF!])
...
* @api
*/
#define MCU_EMIOS_CONFIGURE_GPREN_API ([!IF "McuGeneralConfiguration/McueMiosConfigureGPRENApi"!](STD_ON)[!ELSE!](STD_OFF)[!ENDIF!])
...
#define MCU_ENABLE_DISABLE_NOTIFICATION_API     ([!IF "McuGeneralConfiguration/McuEnableDisableNotificationApi"!]STD_ON[!ELSE!]STD_OFF[!ENDIF!])

[!IF "node:exists('McuGeneralConfiguration/McuEnableDisableNotificationApi')"!]
[!IF "McuGeneralConfiguration/McuEnableDisableNotificationApi"!]
/* the callout clock notification */
/* @violates @ref Mcu_Cfg_h_REF_5 MISRA 2004 Advisory Rule 19.7, Function-like macro */
#define MCU_CLOCK_NOTIFICATION_CALLOUT(cmuIndex) ([!"McuGeneralConfiguration/McuNotification"!](cmuIndex))
/* disable the CMU when CMU error occurs */
#define MCU_DISABLE_CMU
[!ENDIF!]
[!ENDIF!]

[!CODE!][!//
[!SELECT "as:modconf('Mcu')[1]"!][!//
[!IF "(McuGeneralConfiguration/McuConfClkOutput = 'true')"!][!//
    /**
...
[!ELSE!][!//
#define MCU_CONFIGURE_CLK_OUT    (STD_OFF)
[!ENDIF!][!//
[!ENDSELECT!][!//
[!ENDCODE!][!//
...
* @api
*/
#define MCU_XOSC_ISR_USED        ([!IF "count(McuModuleConfiguration/*/McuClockSettingConfig/*/McuXtal_A/McuXtalMaskInterrupt[. = 'true']) >= 1"!]STD_ON[!ELSE!]STD_OFF[!ENDIF!])
/**
...
* characters.
*/
#define MCU_TRANSITION_COMPLETE_ISR_USED        ([!IF "count(McuModuleConfiguration/*/McuInterruptTransition/McuTransitionComplete[. = 'true']) >= 1"!]STD_ON[!ELSE!]STD_OFF[!ENDIF!])
...
* @api
*/
#define MCU_SAFE_MODE_ISR_USED                  ([!IF "count(McuModuleConfiguration/*/McuInterruptTransition/McuSafeMode[. = 'true']) >= 1"!]STD_ON[!ELSE!]STD_OFF[!ENDIF!])
...
* @api
*/
#define MCU_INVALID_MODE_ISR_USED               ([!IF "count(McuModuleConfiguration/*/McuInterruptTransition/McuInvalidMode[. = 'true']) >= 1"!]STD_ON[!ELSE!]STD_OFF[!ENDIF!])
...
* characters.
*/
#define MCU_INVALID_CONFIGURATION_ISR_USED      ([!IF "count(McuModuleConfiguration/*/McuInterruptTransition/McuInvalidConfiguration[. = 'true']) >= 1"!]STD_ON[!ELSE!]STD_OFF[!ENDIF!])
...
* @api
*/
#define MCU_RGM_ALTERNATEMODE_ISR_USED ([!IF "(McuModuleConfiguration/*/McuResetSource/JTAG/McuEnableInterrupt[. = 'true']or McuModuleConfiguration/*/McuResetSource/CORE/McuEnableInterrupt[. = 'true'] or McuModuleConfiguration/*/McuResetSource/PLL/McuEnableInterrupt[. = 'true'] or McuModuleConfiguration/*/McuResetSource/CMU0_OLR/McuEnableInterrupt[. = 'true'] or McuModuleConfiguration/*/McuResetSource/CMU0_FHL/McuEnableInterrupt[. = 'true'] or McuModuleConfiguration/*/McuResetSource/LVD45/McuEnableInterrupt[. = 'true'] or McuModuleConfiguration/*/McuResetSource/FLASH/McuEnableInterrupt[. = 'true'])"!]STD_ON[!ELSE!]STD_OFF[!ENDIF!])
 ...
 * @api
 */
#define MCU_SSCM_ERROR_PAE_ENABLE     ([!IF "McuGeneralConfiguration/McuSscmPAE[.='true']"!]STD_ON[!ELSE!]STD_OFF[!ENDIF!])
 ...
 * @api
 */
#define MCU_SSCM_ERROR_RAE_ENABLE     ([!IF "McuGeneralConfiguration/McuSscmRAE[.='true']"!]STD_ON[!ELSE!]STD_OFF[!ENDIF!])
...
* characters.
*/
#define MCU_DISABLE_DEM_REPORT_ERROR_STATUS   [!IF "$McuDemErrorEnable"!](STD_ON)  /* Enable Production Error Detection */[!ELSE!](STD_OFF) /* Disable Production Error Detection */[!ENDIF!]
...
*/
#define McuConf_McuClockSettingConfig_[!"name(.)"!]   [!"num:i(McuClockSettingId)"!]
[!ENDLOOP!][!//
...
* @violates @ref Mcu_Cfg_h_REF_4 MISRA 2004 Required Rule 1.4, Identifier clash
*/
#define McuConf_McuModeSettingConf_[!"name(.)"!]   [!"num:i(McuMode)"!]
[!ENDLOOP!][!//
...
* @violates @ref Mcu_Cfg_h_REF_4 MISRA 2004 Required Rule 1.4, Identifier clash
*/
#define [!"$McuConfName"!]_[!"name(.)"!]   [!"@index"!]
[!ENDLOOP!][!//
...
[!IF "node:exists('McuGeneralConfiguration/McuEnableDisableNotificationApi')"!][!//
[!IF "McuGeneralConfiguration/McuEnableDisableNotificationApi"!][!//
extern FUNC(void,MCU_CODE) MCU_CLOCK_NOTIFICATION_CALLOUT(VAR (uint8, AUTOMATIC) CmuIndex);
[!ENDIF!][!//
[!ENDIF!][!//
[!IF "count(McuModuleConfiguration/*/McuClockSettingConfig/*/McuXtal_A/McuXtalMaskInterrupt[. = 'true']) >= 1"!]
ISR(Mcu_XOSC_ISR);
[!ENDIF!]

[!IF "count(McuModuleConfiguration/*/McuInterruptTransition/McuTransitionComplete[. = 'true']) >= 1"!]
ISR(Mcu_TransitionComplete_ISR);
[!ENDIF!]

[!IF "count(McuModuleConfiguration/*/McuInterruptTransition/McuInvalidConfiguration[. = 'true']) >= 1"!]
ISR(Mcu_InvalidConfig_ISR);
[!ENDIF!]

[!IF "count(McuModuleConfiguration/*/McuInterruptTransition/McuInvalidMode[. = 'true']) >= 1"!]
ISR(Mcu_InvalidMode_ISR);
[!ENDIF!]

[!IF "count(McuModuleConfiguration/*/McuInterruptTransition/McuSafeMode[. = 'true']) >= 1"!]
ISR(Mcu_EnterSafeMode_ISR);
[!ENDIF!]

[!IF "(McuModuleConfiguration/*/McuResetSource/JTAG/McuEnableInterrupt[. = 'true']or McuModuleConfiguration/*/McuResetSource/CORE/McuEnableInterrupt[. = 'true'] or McuModuleConfiguration/*/McuResetSource/PLL/McuEnableInterrupt[. = 'true'] or McuModuleConfiguration/*/McuResetSource/CMU0_OLR/McuEnableInterrupt[. = 'true'] or McuModuleConfiguration/*/McuResetSource/CMU0_FHL/McuEnableInterrupt[. = 'true'] or McuModuleConfiguration/*/McuResetSource/LVD45/McuEnableInterrupt[. = 'true'] or McuModuleConfiguration/*/McuResetSource/FLASH/McuEnableInterrupt[. = 'true'])"!]
