...
[!IF "(ecu:get('MCU.CGM_OUTPUT_CLK_RC_0') = 'true')"!][!//
#define CLOCK_OUT_SOURCE_RC                (0UL)

#define CLOCK_OUT_SOURCE_XOSC              (1UL)
[!ELSE!][!//
...
[!IF "(ecu:get('MCU.Aux3Clock.Xtal.Value') = '2')"!][!//
#define AUX_CLK_3_XOSC                     2
[!ELSE!][!//
...
#define MCU_MASK_FCCU_SAFE_RESET          ((uint32)0x00800000UL)
[!ENDIF!][!//
...
#define MCU_MASK_CWD_RESET                ((uint32)0x00080000UL)
[!ENDIF!][!//
...
#define MCU_MASK_SOFT_FUNC_RESET         ((uint32)0x00040000UL)  /* Flag for software (functional) reset */
[!ENDIF!][!//
...
#define MCU_MASK_SOFT_DEST_RESET          ((uint32)0x00004000UL)
[!ENDIF!][!//
[!IF "contains(ecu:get('Mcu.ResetReason.List'),'MCU_2_7_LV_ADC_RESET')"!][!//
#define MCU_MASK_LVD27_ADC_RESET          ((uint32)0x00000080UL)  /* Flag for 2.7 V low-voltage det. (ADC supply) */
[!ENDIF!][!//
[!IF "contains(ecu:get('Mcu.ResetReason.List'),'MCU_2_7_LV_IO_RESET')"!][!//
#define MCU_MASK_LVD27_IO_RESET           ((uint32)0x00000040UL)
[!ENDIF!][!//
[!IF "contains(ecu:get('Mcu.ResetReason.List'),'MCU_2_7_LV_FLASH_RESET')"!][!//
#define MCU_MASK_LVD27_FLASH_RESET        ((uint32)0x00000020UL)  /* Flag for 2.7 V low-voltage det. (flash) */
[!ENDIF!][!//
...
#define MCU_MASK_SWT1_D_RESET             ((uint32)0x00000008UL)
[!ENDIF!][!//
...
#define MCU_MASK_HVD12_RESET              ((uint32)0x00000002UL)
[!ENDIF!][!//
...
#define MCU_MASK_LVD12_RESET              ((uint32)0x00000001UL)
[!ENDIF!][!//
