...
[!LOOP "CanConfigSet/*"!]
/* @violates @ref Can_PBcfg_c_REF_10 Violates MISRA 2004 Required Rule 8.10, external ... could be made static */
CONST(Can_IdType, CAN_CONST) Can_FilterMasks[!"@index"!]_PB[CAN_MAXFILTERCOUNT_[!"@index"!]] =
...
CONST(Can_MBConfigObjectType, CAN_CONST) MessageBufferConfigs[!"@index"!]_PB[CAN_MAXMBCOUNT_[!"@index"!]] =
    {
        [!VAR "CanControllerIdValue"="0"!][!VAR "ObjectID"="0"!][!VAR "END_COMMA"="0"!][!VAR "MASK_COUNT"="num:i(count(CanHardwareObject/*))"!][!LOOP "node:order(CanHardwareObject/*,'node:value(CanObjectId)')"!][!VAR "END_COMMA"="$END_COMMA + 1"!]
        [!NOCODE!]
        /*
...
*/
[!VAR "LoopVar"="0"!]
[!LOOP "CanConfigSet/*"!][!VAR "CSET_NR" = "@index"!][!//
[!LOOP "CanController/*"!][!//
[!NOCODE!][!VAR "MASK_COUNT2"="num:i(count(CanControllerBaudrateConfig/*))"!][!VAR "END_COMMA2"="0"!][!ENDNOCODE!]
/* @violates @ref Can_PBcfg_c_REF_10 Violates MISRA 2004 Required Rule 8.10, external ... could be made static */
CONST(Can_ControllerBaudrateConfigType, CAN_CONST) ControllerBaudrateCfgSet[!"$CSET_NR"!]_PB_[!"CanControllerId"!][CAN_CFGSET[!"num:i($CSET_NR)"!]_MAX_BAUDRATE_FC_[!"substring-after(CanHwChannel,'FlexCAN_')"!]_[!"@index"!]] = {
...
[!LOOP "CanConfigSet/*"!][!VAR "CSET_NR" = "@index"!][!//
/* @violates @ref Can_PBcfg_c_REF_10 Violates MISRA 2004 Required Rule 8.10, external ... could be made static */
CONST(Can_ControlerDescriptorType, CAN_CONST) ControlerDescriptors[!"@index"!]_PB[CAN_MAXCONTROLLERCOUNT_[!"@index"!]] =
...
[!LOOP "CanConfigSet/*"!]
/* @violates @ref Can_PBcfg_c_REF_10 Violates MISRA 2004 Required Rule 8.10, external ... could be made static */
CONST(Can_ConfigType, CAN_CONST) [!"@name"!] =
    {
       ...
       (Can_IdPtrType) Can_FilterMasks[!"@index"!]_PB,
        ...
        /* MessageBufferConfigContainer */
        {
            ...
            (Can_HwHandleType)[!"num:i(count(CanHardwareObject/*))"!]U,
        },
