...
==================================================================================================*/
    ...
    [!VAR "CAN_AR_MAJOR_VERSION_TEMPLATE"="4"!]
    [!VAR "CAN_AR_MINOR_VERSION_TEMPLATE"="0"!]
    [!VAR "CAN_AR_PATCH_VERSION_TEMPLATE"="3"!]
    [!VAR "CAN_SW_MAJOR_VERSION_TEMPLATE"="1"!]
    [!VAR "CAN_SW_MINOR_VERSION_TEMPLATE"="0"!]
[!ENDNOCODE!]

[!/* *** multiple inclusion protection *** */!]
[!IF "not(var:defined('CAN_VERSIONCHECK_SRC_PB_M'))"!]
[!VAR "CAN_VERSIONCHECK_SRC_PB_M"="'true'"!]

[!SELECT "CommonPublishedInformation"!]
[!/*
    [!ASSERT "ArMajorVersion = num:i($CAN_AR_MAJOR_VERSION_TEMPLATE)"!]
        **** AUTOSAR major version number of the Basic Software Module Description file (Can.epd version [!"ArMajorVersion"!]) and the Code template file (Can_PBcfg.c  version [!"num:i($CAN_AR_MAJOR_VERSION_TEMPLATE)"!]) are different ****
    [!ENDASSERT!]

    [!ASSERT "ArMinorVersion  = num:i($CAN_AR_MINOR_VERSION_TEMPLATE)"!]
        **** AUTOSAR minor version number of the Basic Software Module Description file (Can.epd version [!"ArMinorVersion"!]) and the Code template file (Can_PBcfg.c  version [!"num:i($CAN_AR_MINOR_VERSION_TEMPLATE)"!]) are different ****
    [!ENDASSERT!]

    [!ASSERT "ArPatchVersion  = num:i($CAN_AR_PATCH_VERSION_TEMPLATE)"!]
        **** AUTOSAR patch version number of the Basic Software Module Description file (Can.epd version [!"ArPatchVersion"!]) and the Code template file (Can_PBcfg.c  version [!"num:i($CAN_AR_PATCH_VERSION_TEMPLATE)"!]) are different ****
    [!ENDASSERT!]
*/!]
