...
*   @version 1.0.1
*
*   @brief   AUTOSAR Lin - Lin postbuild configuration parameters.
*   @details This file contains the Lin postbuild configuration parameters.
*
*   @addtogroup LIN
*   @{
*/
...
*/
/* @violates @ref Lin_PBcfg_c_REF_7 This is required as per Autosar Requirement. */
...
#define LIN_SW_PATCH_VERSION_PBCFG_C               1
...
#if ((LIN_AR_RELEASE_MAJOR_VERSION_PBCFG_C    != LIN_AR_RELEASE_MAJOR_VERSION) || \
     (LIN_AR_RELEASE_MINOR_VERSION_PBCFG_C    != LIN_AR_RELEASE_MINOR_VERSION) || \
     (LIN_AR_RELEASE_REVISION_VERSION_PBCFG_C != LIN_AR_RELEASE_REVISION_VERSION))
...
/* Check if current file and Lin.h header file are of the same Software version */
  ...
  #if ((LIN_AR_RELEASE_MAJOR_VERSION_PBCFG_C != STD_TYPES_AR_RELEASE_MAJOR_VERSION) || \
       (LIN_AR_RELEASE_MINOR_VERSION_PBCFG_C != STD_TYPES_AR_RELEASE_MINOR_VERSION))
...
*                 [!"$nodeName"!].
*
* @implements     DLIN03603
* 
* @api
*/
/**
* @violates @ref Lin_PBcfg_c_REF_6 All declarations and definitions
...
*                internal linkage unless external linkage is required.
*/
CONST(Lin_ConfigType,LIN_CONST)[!"@name"!] =
    {
[!VAR "LoopVar"="0"!][!//
[!VAR "count"="0"!][!//
...
[!IF "$LoopVar = 0"!]
[!CODE!]     /** 
     * @violates @ref Lin_PBcfg_c_REF_4 there is no need to have braces
     *                in "Lin_ConfigType" structure.
     */
[!ENDCODE!]
[!ENDIF!]
[!ENDNOCODE!][!//
...
[!ENDFOR!][!//
    ...
    /**
     * @brief   sDEM error parameters.
     */
#if (LIN_DISABLE_DEM_REPORT_ERROR_STATUS == STD_ON)
    /*
    * @violates @ref Lin_PBcfg_c_REF_5 The value of an expression of
...
/*
* @violates @ref Lin_PBcfg_c_REF_1 Precautions shall be taken in order to prevent the contents
*        of a header file being included twice.
*/
/*
* @violates @ref Lin_PBcfg_c_REF_2 Only preprocessor 
