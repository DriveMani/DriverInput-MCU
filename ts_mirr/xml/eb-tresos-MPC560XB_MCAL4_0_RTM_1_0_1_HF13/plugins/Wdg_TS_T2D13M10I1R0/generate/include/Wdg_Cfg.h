...
*                                      DEFINES AND MACROS
==================================================================================================*/
[!CALL "WDG_CHECK_CBK_NOTIFICATION","SWT_INSTANCE"="'SWT0'"!]

/* @violates @ref Wdg_Cfg_h_REF_4 MISRA 2004 Required Rule 19.4, expand C marcos */
[!CALL "WDG_INSTANCE","SWT_INSTANCE" = "'SWT0'"!]

/**
* @brief  This constant specifies what value of the CR's master access protection will be used
*/
/* @violates @ref Wdg_Cfg_h_REF_4 MISRA 2004 Required Rule 19.4, expand C marcos */
#define SWT_MAP_ENABLE_BITS [!//
[!IF "./WdgGeneral/WdgMasterAccessProtection = 'ALL_MAPx'"!][!//
          SWT_MAP_ENABLE_8BITS[!//
[!ELSEIF "./WdgGeneral/WdgMasterAccessProtection = 'MAP0'"!][!//
          SWT_MAP0_ENABLE[!//
[!ELSEIF "./WdgGeneral/WdgMasterAccessProtection = 'MAP1'"!][!//
          SWT_MAP1_ENABLE[!//
[!ELSEIF "./WdgGeneral/WdgMasterAccessProtection = 'MAP2'"!][!//
          SWT_MAP2_ENABLE[!//
[!ELSEIF "./WdgGeneral/WdgMasterAccessProtection = 'MAP3'"!][!//
          SWT_MAP3_ENABLE[!//
[!ELSEIF "./WdgGeneral/WdgMasterAccessProtection = 'MAP4'"!][!//
          SWT_MAP4_ENABLE[!//
[!ELSEIF "./WdgGeneral/WdgMasterAccessProtection = 'MAP5'"!][!//
          SWT_MAP5_ENABLE[!//
[!ELSEIF "./WdgGeneral/WdgMasterAccessProtection = 'MAP6'"!][!//
          SWT_MAP6_ENABLE[!//
[!ELSEIF "./WdgGeneral/WdgMasterAccessProtection = 'MAP7'"!][!//
          SWT_MAP7_ENABLE[!//
[!ELSE!][!//
          (SWT_MAP0_ENABLE|SWT_MAP1_ENABLE)[!//
[!ENDIF!]
 ...
 */
#define WDG_NO_OF_INSTANCES            ([!"num:i(ecu:get('Wdg.WdgLastInstanceOfPlatform')+1)"!])
...
*/
/* @violates @ref Wdg_Cfg_h_REF_4 MISRA 2004 Required Rule 19.4, expand C marcos */
#define WdgConf_WdgGeneral_[!"node:name(WdgGeneral/WdgIndex)"!] (uint8)[!"num:i(WdgGeneral/WdgIndex)"!]

/**
* @brief  This variable will indicate the Wdg Initial Timeout parameter
*/
[!IF "num:i(WdgGeneral/WdgInitialTimeout * 1000) > 0"!]
/* @violates @ref Wdg_Cfg_h_REF_4 MISRA 2004 Required Rule 19.4, expand C marcos */
#define WDG_INITIAL_TIMEOUT [!"WdgGeneral/WdgInitialTimeout * 1000"!]
[!ENDIF!]
...
*/
/* @violates @ref Wdg_Cfg_h_REF_4 MISRA 2004 Required Rule 19.4, expand C marcos */
#define WDGMAXTIMEOUT       (uint16)[!"WdgGeneral/WdgMaxTimeout * 1000"!]
[!CALL "WDG_ISR","WDG_SWT_INSTANCE" = "'SWT0'"!]
...
[!IF "./WdgKeyedService"!]
/** 
* @brief  This variable will indicate if that the WdgKeyedService is used
*/
...
/* @violates @ref Wdg_Cfg_h_REF_3 MISRA 2004 Required Rule 5.1, Identifier exceeds 31 characters */
/* @violates @ref Wdg_Cfg_h_REF_4 MISRA 2004 Required Rule 19.4, expand C marcos */
#define WDG_DISABLE_DEM_REPORT_ERROR_STATUS   [!IF "$WdgDemErrorEnable"!]STD_ON  /* Enable Production Error Detection */[!ELSE!]STD_OFF /* Disable Production Error Detection */[!ENDIF!]
/*==================================================================================================
*                                             ENUMS
==================================================================================================*/
/**
...
[!NOCODE!][!//
    [!VAR "Wdg_NumberOfCfg"="num:i(count(WdgSettingsConfig/*))"!][!//
    [!VAR "Wdg_CrtNoOfCfg"="0"!][!//
[!ENDNOCODE!][!//
[!LOOP "WdgSettingsConfig/*"!][!//
    extern CONST(Wdg_ConfigType, WDG_CONST) [!"@name"!];[!//
...
[!LOOP "WdgSettingsConfig/*"!][!//
[!FOR "i" = "0" TO "1"!][!//
[!IF "$i = num:i(substring-after(./WdgInstance,'SWT'))"!][!//
...
/* @violates @ref Wdg_Cfg_h_REF_4 MISRA 2004 Required Rule 19.4, expand C marcos */
#define WDG_LINKTIME_SUPPORT STD_ON
/**
* @brief Defines the use of Link Time (LT) support
*/
/* @violates @ref Wdg_Cfg_h_REF_4 MISRA 2004 Required Rule 19.4, expand C marcos */
#define WDG_CFG_EXTERN_DECLARATIONS \
[!NOCODE!][!//
...
[!FOR "i" = "0" TO "1"!][!//
[!IF "$i = num:i(substring-after(./WdgInstance,'SWT'))"!][!//
    extern CONST(Wdg_ConfigType, WDG_CONST) Wdg_ConfigLT[!"$i"!];[!//
[!ENDIF!][!//
[!ENDFOR!][!//
[!IF "(num:i(@index)+1) < $Wdg_NumberOfCfg"!]\[!ENDIF!]
[!ENDLOOP!][!//
