...
[!ASSERT "num:i(ArMajorVersion) = num:i($WDG_AR_MAJOR_VERSION_TEMPLATE)"!]
        **** AUTOSAR major version number of the Basic Software Module Description file (Wdg.epd version [!"ArMajorVersion"!]) and the Code template file (Wdg_Cfg.h version [!"num:i($WDG_AR_MAJOR_VERSION_TEMPLATE)"!]) are different ****
[!ENDASSERT!][!//
[!ASSERT "num:i(ArMinorVersion)  = num:i($WDG_AR_MINOR_VERSION_TEMPLATE)"!]
        **** AUTOSAR minor version number of the Basic Software Module Description file (Wdg.epd version [!"ArMinorVersion"!]) and the Code template file (Wdg_Cfg.h version [!"num:i($WDG_AR_MINOR_VERSION_TEMPLATE)"!]) are different ****
[!ENDASSERT!][!//
[!ASSERT "num:i(ArPatchVersion)  = num:i($WDG_AR_PATCH_VERSION_TEMPLATE)"!]
        **** AUTOSAR patch version number of the Basic Software Module Description file (Wdg.epd version [!"ArPatchVersion"!]) and the Code template file (Wdg_Cfg.h version [!"num:i($WDG_AR_PATCH_VERSION_TEMPLATE)"!]) are different ****
[!ENDASSERT!][!//
*/!]
[!ASSERT "num:i(SwMajorVersion) = num:i($WDG_SW_MAJOR_VERSION_TEMPLATE)"!]
        **** The software major number of the Basic Software Module Description file (Wdg.epd version [!"SwMajorVersion"!]) and the Code template file (Wdg_Cfg.h version [!"num:i($WDG_SW_MAJOR_VERSION_TEMPLATE)"!]) are different ****
[!ENDASSERT!][!//
