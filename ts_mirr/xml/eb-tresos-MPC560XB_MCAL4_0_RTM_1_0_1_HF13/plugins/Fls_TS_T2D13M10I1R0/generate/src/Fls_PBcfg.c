...
*
* @section fls_pbcfg_c_REF_9
* Violates MISRA 2004 Advisory Rule 19.1, Only preprocessor statements and comments before '#include'
* Because of Autosar requirement MEMMAP003 of memory mapping
*
* @section fls_pbcfg_c_REF_11
...
/*
* @violates @ref fls_pbcfg_c_REF_13 The compiler/linker shall be checked
* to ensure that 31 character significance and case sensitivity are supported for external identifiers
*/
/*
* @violates @ref fls_pbcfg_c_REF_15 Identifiers more than 31 characters.
*/
...
* @violates @ref fls_pbcfg_c_REF_15 Identifiers more than 31 characters.
*/
#define FLS_AR_RELEASE_MINOR_VERSION_CFG_C       0
/*
* @violates @ref fls_pbcfg_c_REF_13 The compiler/linker shall be checked
* to ensure that 31 character significance and case sensitivity are supported for external identifiers
*/
...
* @violates @ref fls_pbcfg_c_REF_15 Identifiers more than 31 characters.
*/
#define FLS_AR_RELEASE_REVISION_VERSION_CFG_C    3
...
/* @violates @ref fls_pbcfg_c_REF_20 Implicitly converted to a different underlying type */
...
/*
* @violates @ref fls_pbcfg_c_REF_1 Precautions shall be taken
* in order to prevent the contents of a header being included twice.
* @violates @ref fls_pbcfg_c_REF_9 Only preprocessor statements
...
/*
* @violates @ref fls_pbcfg_c_REF_31  An external object or function shall be declared in one and only one file
*/
...
/*
* @violates @ref fls_pbcfg_c_REF_21 The name of standard library macros, objects and functions shall not be reused
* @violates @ref fls_pbcfg_c_REF_30 Typedefs that indicate size and signedness 
...
/*
* @violates @ref fls_pbcfg_c_REF_11 All declarations and definitions
...
{
    /*
    * @violates @ref fls_pbcfg_c_REF_12 A cast shall not be performed that removes any const and
    * volatile qualification from the type address by a pointer
    * @violates @ref fls_pbcfg_c_REF_2 A cast should not be performed
    * between a pointer to object type and a different pointer to object type
    * @violates @ref fls_pbcfg_c_REF_8 Conversions shall not be performed between 
    * a pointer to a function and any type other than an integral type
    * @violates @ref fls_pbcfg_c_REF_4 No reliance shall be placed on
    ...
    */       
    ...
    /*
    * @violates @ref fls_pbcfg_c_REF_29 A function identifier shall only be used with either a
    * preceding &, or with a parenthesised parameter list, which may be empty.
    */      
