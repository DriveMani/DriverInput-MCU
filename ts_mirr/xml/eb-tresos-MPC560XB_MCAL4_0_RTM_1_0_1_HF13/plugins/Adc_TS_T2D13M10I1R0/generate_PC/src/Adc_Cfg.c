...
*/
[!LOOP "AdcConfigSet/*[1]/AdcHwUnit/*/AdcChannel/*/AdcThresholdControl"!][!//
...
STATIC CONST(Adc_HwTriggerTimerType, ADC_CONST) Adc_GroupTriggerSource[!"AdcGroupId"!]_PC[[!"num:i(count(AdcHwTrig/*))"!]] =
{
[!VAR "INTINDEX" = "0"!][!//
[!LOOP "AdcHwTrig/*"!][!//
...
{
[!FOR "x" = "0" TO "num:i(count(AdcConfigSet/*[1]/AdcHwUnit/*[AdcHwUnitId='ADC_UNIT_0']/AdcChannel/*)-1)"!][!//
...
[!ENDIF!][!//
[!ENDLOOP!][!//
  }[!IF "$x < (count(AdcConfigSet/*[1]/AdcHwUnit/*[AdcHwUnitId='ADC_UNIT_0']/AdcChannel/*)-1)"!],[!ELSE!][!ENDIF!]
...
/**
* @brief          Definition of channels on ADC Hardware unit 1.
* @details        Array of conversion command messages.
*
* @implements     DADC04080
*/
STATIC CONST(Adc_LLD_ChannelConfiguration, ADC_CONST) Adc_Channels_CfgPC_1[] =
{
[!FOR "x" = "0" TO "num:i(count(AdcConfigSet/*[1]/AdcHwUnit/*[AdcHwUnitId='ADC_UNIT_1']/AdcChannel/*)-1)"!][!//
[!LOOP "AdcConfigSet/*[1]/AdcHwUnit/*/AdcChannel/*"!][!//
[!VAR "Loop"="num:i($LoopVar)"!][!//
[!IF "../../AdcHwUnitId = 'ADC_UNIT_1'"!][!//
[!IF "AdcChannelId = $Loop"!][!//
...
[!ENDIF!][!//
[!ENDLOOP!][!//
  }[!IF "$x < (count(AdcConfigSet/*[1]/AdcHwUnit/*[AdcHwUnitId='ADC_UNIT_1']/AdcChannel/*)-1)"!],[!ELSE!][!ENDIF!]
[!VAR "LoopVar"="$LoopVar + 1"!][!//
[!ENDFOR!][!//
};
[!ENDIF!][!//
...
{
[!IF "AdcConfigSet/*[1]/AdcHwUnit/*/AdcHwUnitId = 'ADC_UNIT_0'"!][!//
  Adc_Channels_CfgPC_0,
[!ELSE!][!//
  NULL_PTR,
[!ENDIF!][!//
[!IF "AdcConfigSet/*[1]/AdcHwUnit/*/AdcHwUnitId = 'ADC_UNIT_1'"!][!//
...
[!ENDNOCODE!]
  /**< @brief Group[!"AdcGroupId"!] -- Hardware Unit [!"../../AdcHwUnitId"!] */
  {
    ...
    [!IF "(../../../../../../AdcGeneral/AdcHwTriggerApi = 'true') and (AdcGroupTriggSrc = 'ADC_TRIGG_SRC_HW')"!]Adc_GroupTriggerSource[!"AdcGroupId"!]_PC[!ELSE!][!"num:i(0)"!]U[!ENDIF!],
    ...
    (uint32)[!"num:inttohex($AdcPrecise_Ch)"!],
    /**< @brief Extended configured channels */
    (uint32)[!"num:inttohex($AdcExtd_Ch)"!],
    /**< @brief External configured channels */
    (uint32)[!"num:inttohex($AdcExternal_Ch)"!],
...
[!ENDIF!][!//
    ...
    [!IF "../../AdcHwUnitId = 'ADC_UNIT_0' "!]ADC_Group[!"AdcGroupId"!]_Assignment_PC_0,[!ELSE!]ADC_Group[!"AdcGroupId"!]_Assignment_PC_1,[!ENDIF!]
...
CONST(Adc_ConfigType, ADC_CONST) Adc_ConfigPC =
{
  ...
  [!IF "AdcConfigSet/*[1]/AdcGeneric/AdcTransferType = 'ADC_DMA'"!][!//
    ...
    [!"AdcConfigSet/*[1]/AdcGeneric/AdcTransferType"!],
  [!ELSE!][!//
  ...
  [!ENDIF!]
    ...
    [!"num:i(count(AdcConfigSet/*[1]/AdcHwUnit/*/AdcGroup/*))"!]U,
    /**< @brief number of the maximum hardware units in the current configuration */
    [!"num:i(count(AdcConfigSet/*[1]/AdcHwUnit/*))"!]U,
    /**< @brief depth of the queue */
    [!"AdcConfigSet/*[1]/AdcGeneric/AdcPriorityQueueMaxDepth"!]U,
...
[!IF "$BOLERO256K=0"!],
      (uint8)[!"num:i($channels_hw_unit1)"!]  /* number of channels of the hw unit 1 */
[!ENDIF!][!//
    },
    {[!//
      [!IF "AdcConfigSet/*[1]/AdcGeneric/AdcTransferType = 'ADC_DMA'"!][!//
      [!NOCODE!][!//
        [!FOR "x" = "0" TO "num:i(count(AdcConfigSet/*[1]/AdcHwUnit/*))"!][!//
        [!LOOP "AdcConfigSet/*[1]/AdcHwUnit/*"!][!//
        [!VAR "Loop"="num:i($LoopVar)"!][!//
    ...
    },
    {
      ...
      [!IF "AdcConfigSet/*[1]/AdcHwUnit/*/AdcHwUnitId = 'ADC_UNIT_0'"!](uint8)STD_ON[!ELSE!](uint8)STD_OFF[!ENDIF!],
        [!IF "$BOLERO256K=0"!][!//
      /**< @brief ADC_UNIT_1 - ON/OFF */
      [!IF "AdcConfigSet/*[1]/AdcHwUnit/*/AdcHwUnitId = 'ADC_UNIT_1'"!](uint8)STD_ON[!ELSE!](uint8)STD_OFF[!ENDIF!]
        [!ENDIF!][!//
    },
    {
     [!NOCODE!][!//
      ...
      (uint8)[!"num:i($mhtGroups_hw_1)"!]  /* number of MHT groups of the hw unit 1 */
      [!ENDIF!][!//
    }
    }
};
