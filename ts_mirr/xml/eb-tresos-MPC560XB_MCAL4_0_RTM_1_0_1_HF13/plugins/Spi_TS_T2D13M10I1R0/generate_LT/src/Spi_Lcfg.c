...
VAR_ALIGN(static VAR(Spi_BufferDescriptor, SPI_VAR) Buffer_LT[!"name(.)"!], 2)
[!ELSE!][!//
static VAR(Spi_BufferDescriptor, SPI_VAR) Buffer_LT[!"name(.)"!];
[!ENDIF!][!//
[!ELSE!][!//
static VAR(Spi_BufferDescriptor, SPI_VAR) Buffer_LT[!"name(.)"!];
[!ENDIF!][!//
...
[!IF "node:exists(../../../../SpiNonAUTOSAR/SpiForceDataType) and (node:value(../../../../SpiNonAUTOSAR/SpiForceDataType) = 'true')"!][!//
[!IF "num:i(SpiDataWidth) > 8"!][!//
VAR_ALIGN(static VAR(Spi_DataType, SPI_VAR) BufferTX_LT[!"name(.)"!][[!"SpiIbNBuffers"!]], 2)
VAR_ALIGN(static VAR(Spi_DataType, SPI_VAR) BufferRX_LT[!"name(.)"!][[!"SpiIbNBuffers"!]], 2)
[!ELSE!][!//
static VAR(Spi_DataType, SPI_VAR) BufferTX_LT[!"name(.)"!][[!"SpiIbNBuffers"!]];
static VAR(Spi_DataType, SPI_VAR) BufferRX_LT[!"name(.)"!][[!"SpiIbNBuffers"!]];
[!ENDIF!][!//
[!ELSE!][!//
static VAR(Spi_DataType, SPI_VAR) BufferTX_LT[!"name(.)"!][[!"SpiIbNBuffers"!]];
static VAR(Spi_DataType, SPI_VAR) BufferRX_LT[!"name(.)"!][[!"SpiIbNBuffers"!]];
...
[!LOOP "SpiDriver/*[1]/SpiChannel/*"!][!//
[!IF "SpiChannelType = 'IB'"!][!//
static CONST(Spi_BufferDescriptor, SPI_CONST) Buffer_LT[!"name(.)"!] =
{
    BufferTX_LT[!"name(.)"!],
    BufferRX_LT[!"name(.)"!]
};
...
static CONST(Spi_ChannelConfig, SPI_CONST) SpiChannelConfig_LT[[!"num:i($count)"!]] =
{
...
* @violates @ref Spi_Lcfg_c_REF_6 This is required as per autosar Requirement, 
*/
static CONST(Spi_ChannelType, SPI_CONST) [!"name(.)"!]_ChannelAssignment_LT[[!"num:i(count(SpiChannelList/*))"!]] = {[!//
[!LOOP "SpiChannelList/*"!][!//
[!IF "@index > 0"!],[!ENDIF!][!//
...
static CONST(Spi_JobConfig, SPI_CONST) SpiJobConfig_LT[[!"num:i($count)"!]] =
{
...
[!VAR "WhiteSpaceInstartJobNotification1"="normalize-space(SpiJobStartNotification)"!]
        ...
        [!"name(.)"!]_ChannelAssignment_LT, /* List of Channels */
...
* @violates @ref Spi_Lcfg_c_REF_6 This is required as per autosar Requirement, 
*/
static CONST(Spi_JobType, SPI_CONST) [!"name(.)"!]_JobAssignment_LT[[!"num:i(count(SpiJobAssignment/*))"!]] = {[!//
[!LOOP "SpiJobAssignment/*"!][!//
...
static CONST(Spi_SequenceConfig, SPI_CONST) SpiSequenceConfig_LT[[!"num:i(count(SpiDriver/*[1]/SpiSequence/*))"!]] =
{
...
[!VAR "WhiteSpaceInSeqEndNotification1"="normalize-space(SpiSeqEndNotification)"!]
        ...
        [!"name(.)"!]_JobAssignment_LT, /* List of Jobs */
...
[!VAR "LoopVar"="0"!][!//
[!VAR "count" = "count(SpiDriver/*[1]/SpiChannel/*)"!][!//
/* DspiChannelAttributesConfig_LT[!"@index"!] Channel Attribute Configuration of [!"name(.)"!]*/
static CONST(Spi_LLD_ChannelAttributesConfig, SPI_CONST) DspiChannelAttributesConfig_LT[[!"num:i(count(SpiDriver/*[1]/SpiChannel/*))"!]] =
{
[!FOR "x" = "0" TO "num:i(count(SpiDriver/*[1]/SpiChannel/*))"!][!//
[!LOOP "SpiDriver/*[1]/SpiChannel/*"!][!//
[!VAR "Loop"="num:i($LoopVar)"!][!//
...
/* DspiDeviceAttributesConfig_LT[!"@index"!] Device Attribute Configuration of [!"name(.)"!]*/
static CONST(Spi_LLD_DeviceAttributesConfig, SPI_CONST) DspiDeviceAttributesConfig_LT[[!"num:i(count(SpiDriver/*[1]/SpiExternalDevice/*))"!]] =
{
