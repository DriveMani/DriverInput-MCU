...
*/
/*
* @violates @ref PORT_PBCFG_REF_6 Identifiers (internal and external) shall not rely on the significance of more than 31
* characters.
*/
...
/*
* @file  Port_PBcfg.c
* @implements   DPORT00014
*/
/* @violates @ref PORT_PBCFG_REF_1 only preprocessor statements and comments before '#include' */
/*
* @violates @ref PORT_PBCFG_REF_3 Precautions shall be taken in order to prevent
...
*/
#if (Port_NoUnUsedPins_[!"@index"!] != 0)
/*
* @brief NoDefaultPadsArray is an array containing Unimplemented pads and User pads
*/
/*
* @violates @ref PORT_PBCFG_REF_5 Violates MISRA 2004 Required Rule 8.10
*/
CONST(uint16,PORT_CONST) Port_NoUnUsedPadsArrayDefault_[!"@index"!][Port_NoUnUsedPins_[!"@index"!]]=
{
...
* @violates @ref PORT_PBCFG_REF_5 Violates MISRA 2004 Required Rule 8.10
*/
CONST(Port_LLD_UnUsedPinConfigType, PORT_CONST) Port_LLD_UnUsedPin_[!"@index"!][1] =
{
 /**
...
*/
/*
* @violates @ref PORT_PBCFG_REF_5 All declarations and definitions of objects or
* functions at file scope shall have internal linkage unless external linkage is required.
*/
...
*/
/**
* @brief Pad selection default configuration for configPB_[!"@index"!]
*/
/*
* @violates @ref PORT_PBCFG_REF_5 Violates MISRA 2004 Required Rule 8.10
*/
/*
* @violates @ref PORT_PBCFG_REF_4 Violates MISRA 2004 Required Rule 1.4
*/
CONST(Port_LLD_PadSelConfigType, PORT_CONST) Port_LLD_PadSelConfigPB_[!"@index"!][PORT_NMBR_PSMI_REGS]=
{
[!NOCODE!]
[!/* PSMI0 */!]
[!VAR "cPSMI0"="0"!][!//
...
CONST(Port_ConfigType, PORT_CONST) [!"@name"!] =
{
  ...
  Port_NoUnUsedPins_[!"@index"!],
/*
* @violates @ref PORT_PBCFG_REF_2 Violates MISRA 2004 Required Rule 10.1, Implicit
* conversion changes signedness.
*/ 
#if (Port_NoUnUsedPins_[!"@index"!] != 0)
  Port_NoUnUsedPadsArrayDefault_[!"@index"!],
#else
  NULL_PTR,
#endif
  Port_LLD_UnUsedPin_[!"@index"!],
  Port_LLD_PinConfigPB_[!"@index"!],
/*
* @violates @ref PORT_PBCFG_REF_2 Violates MISRA 2004 Required Rule 10.1, Implicit
* conversion changes signedness.
*/
  Port_LLD_PadSelConfigPB_[!"@index"!]
};
[!ENDLOOP!][!//
