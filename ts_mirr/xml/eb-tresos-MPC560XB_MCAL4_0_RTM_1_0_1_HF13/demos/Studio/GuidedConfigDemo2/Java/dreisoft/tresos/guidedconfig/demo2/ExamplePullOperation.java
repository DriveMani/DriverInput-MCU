 ...
 * All rights reserved
 *
 * NAME: test.tresos.plugin.guidedconfig.pushservice.operation.ExamplePullOperation
 */
 ...
 * 
 * <p>
 * This operation serves the {@link Demo3Backend} to write to the project configuration and the {@link Demo2Backend} to
 * load from the project configuration and store to the project configuration.
 * </p>
 * 
 * <p>
...
public class ExamplePullOperation extends AbstractConfigurablePushOperation {
     ...
     * 
     *        <p>
     *        The demo implementation serves the {@link Demo2Backend} and the {@link Demo3Backend}.
     *        </p>
     * 
