 ...
 * All rights reserved
 *
 * NAME: test.tresos.plugin.guidedconfig.pushservice.operation.ExampleAutoconfigureEvent
 */
...
public class ExampleAutoconfigureEvent extends AbstractPushEvent {
    ...
    /**
     * Set the nodes that have been changed. This method is used together with {@link #getChangedNodes()}, if this
    ...
    /**
     * Query the nodes that have been changed. This method is used together with {@link #setChangedNodes(List)}, if
     * this event is not used within an transaction - see {@link #getTransactionLogs()}
     * 
