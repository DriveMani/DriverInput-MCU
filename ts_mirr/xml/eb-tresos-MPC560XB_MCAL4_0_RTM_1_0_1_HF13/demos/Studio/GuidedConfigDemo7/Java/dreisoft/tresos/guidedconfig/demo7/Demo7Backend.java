 ...
 * All rights reserved
 *
 * NAME: test.tresos.plugin.guidedconfig.demo7.Demo7Backend
 */
...
import dreisoft.tresos.guidedconfig.api.backend.AbstractDCtxtBackend;
 ...
 * @since 2010.a
 */
public class Demo7Backend extends AbstractDCtxtBackend {
    ...
    public List<APIOperationStatus> doRun() {
        ...
        // Get the list of changed nodes and add them to the resultwidget
